...
vim.keymap.set({"n", "t"}, "<C-Left>", function() vim.cmd([[bprev]]) end)
vim.keymap.set({"n", "t"}, "<C-Right>", function() vim.cmd([[bnext]]) end)
vim.keymap.set("n", "<C-Down>", function() pcall(vim.cmd, [[cprev]]) end)
vim.keymap.set("n", "<C-Up>", function() pcall(vim.cmd, [[cnext]]) end)

vim.keymap.set({"n", "t"}, "<S-Left>", function() vim.cmd([[wincmd h]]) end)
vim.keymap.set({"n", "t"}, "<S-Right>", function() vim.cmd([[wincmd l]]) end)
vim.keymap.set({"n", "t"}, "<S-Down>", function() vim.cmd([[wincmd j]]) end)
vim.keymap.set({"n", "t"}, "<S-Up>", function() vim.cmd([[wincmd k]]) end)
